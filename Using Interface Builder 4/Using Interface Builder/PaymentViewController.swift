...
class PaymentViewController: UIViewController {
    ...
    @IBAction func displayGenre(_ sender: UIButton) {
        ...
        for genre in genres {
            displayText += "ID: \(genre.id), Name: \(genre.name), Amount: \(genre.paymentAmount), Date: \(genre.paymentDate), Method: \(genre.paymentMethod), Status: \(genre.paymentStatus)\n"
        }
        showAlert(title: "Payment", message: displayText)
    }
