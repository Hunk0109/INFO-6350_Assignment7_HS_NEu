...
class PolicyViewController: UIViewController {
    ...
    func handleArtistSelectionForAlbum(artist: Artist, title: String, releaseDate: String, endDate: String, premiumAmount: String, policyType: String) {
        ...
        let album = Album(id: albumId, artistId: artist.id, title: title, releaseDate: policyType, endDate: releaseDate, premium_amoumt: endDate, policyType: policyType)
    ...
    @IBAction func displayAlbum(_ sender: UIButton) {
        ...
        for album in SharedData.shared.albums {
            ...
            displayText += "ID: \(album.id), Customer: \(artistName), Title: \(album.title), Start Date: \(album.releaseDate), End Date: \(album.endDate), Premium Amount: \(album.premium_amoumt), Policy Type: \(album.policyType)\n"
        }
        showAlert(title: "Policy", message: displayText)
    }
